...
// Guess this enables/disables microstepping, honestly no idea what it does
// 0 = disable, 1 = enable
//
// UART return:
// status 1 = Set success - status 0 = Set failed
...
// no max value provided in the docs, display menu shows up to 1042?
